...
prop_consuming_an_item_leaves_one_item_less_in_sum() ->
...
prop_producing_an_item_leaves_one_item_more_in_sum() ->
  ?FORALL({S, Item}, filled_storage_and_index(),
